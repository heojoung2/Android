...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, PlacesListener,
    ...
    String[] places = {"음식점", "은행", "공항", "카페", "병원", "약국", "지하철"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                showPlaceInformation(currentPosition, places[i]);
            }
            //아무것도 선택되지 않았을 때 호출됨
            @Override
    ...
    public void showPlaceInformation(LatLng location, String place){
        ...
        if (place == "음식점"){
            new NRPlaces.Builder()
                    ...
                    .key("AIzaSyAc_7d_cLwY86_bKqb9V0YNsx1wFxMY0Ic")
            ...
            new NRPlaces.Builder()
                    ...
                    .latlng(location.latitude, location.longitude)//현재 위치
                    .radius(500) //500 미터 내에서 검색
                    .type(PlaceType.SUBWAY_STATION) //음식점
                    .build()
                    .execute();
        }
    }
